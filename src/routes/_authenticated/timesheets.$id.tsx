...
function printTimesheetPDF(sub: Submission, shifts: Shift[]) {
  ...
  const html = `<!DOCTYPE html><html><head>
    ...
    <div class="header">
      <div style="display:flex;align-items:center;gap:10px"><img src="https://ltpsljknjenpomsxixlx.supabase.co/storage/v1/object/public/brand/Logo-blue.png" style="height:36px;object-fit:contain;" alt="Soar Recruitment" /><div style="font-size:11px;color:#94a3b8;margin-top:2px;">Timesheet Record</div></div>
